  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans py-12">
      <div className="container max-w-4xl">
        ...
        <h1 className="text-4xl font-bold font-poppins mb-8">Impressum</h1>

        <div className="space-y-8 text-muted-foreground">
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">Angaben gemäß § 5 TMG</h2>
            <h3 className="font-bold text-foreground mb-2">Anbieter</h3>
            <p>
          ...
          <section>
            ...
            <p>
              Telefon: <a href="tel:+491715060008" className="text-primary hover:underline">+49 171 5060008</a><br />
              E-Mail: <a href="mailto:info@lr-lifestyle.info" className="text-primary hover:underline">info@lr-lifestyle.info</a>
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">EU-Streitschlichtung</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h2>
            <p>
